...
(() => {
  ...
  class liquidGLRenderer {
    constructor(snapshotSelector, snapshotResolution = 1.0) {
      ...
      this.canvas.style.cssText = `position:fixed;top:0;left:0;width:100%;height:100%;pointer-events:none;z-index:0;opacity:1;`;
    ...
    _uploadTexture(srcCanvas) {
      ...
      // FORCE VISIBILITY: Ensure canvas is visible immediately
  ...
  class liquidGLLens {
    ...
    _createMirrorCanvas() {
      ...
      const updateClip = () => {
        ...
        this._mirror.style.clipPath = `inset(${r.top}px ${innerWidth - r.right
